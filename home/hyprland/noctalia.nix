{ ... }: {
  wayland.windowManager.hyprland.extraConfig = ''
    ...
    hl.bind("SUPER + A",      hl.dsp.exec_cmd("noctalia-shell ipc call controlCenter toggle"))
    ...
    hl.bind("SUPER + ESCAPE", hl.dsp.exec_cmd("noctalia-shell ipc call sessionMenu toggle"))
    hl.bind("SUPER + W",      hl.dsp.exec_cmd("noctalia-shell ipc call wallpaper toggle"))
    hl.bind("SUPER + C",      hl.dsp.exec_cmd("noctalia-shell ipc call launcher clipboard"))
